##Download the file and put the file in the data7 folder 
if(!file.exists("./data7")){dir.create("./data7")}
fileUrl <- "https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip"
download.file(fileUrl,destfile="./data7/Dataset.zip")
##Unzip the file
unzip(zipfile="./data7/Dataset.zip",exdir="./data7")
##unzipped files are in the folderUCI HAR Dataset. Get the list of the files
path_rf <- file.path("./data7" , "UCI HAR Dataset")
